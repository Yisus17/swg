            ...
            <div class="col-md-12">
                <div class="panel panel-visible">
                    ...
                    <div class="panel-body pn">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline"" id="categoria-table" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th >Descripción</th>
                            </tr>
            ...
            buttons: [

                {
                    ...
                    action: function ( e, dt, node, config ) {
                        window.location.href='{!! url("categoria/create")!!}';
                    }
                },
                {
                    extend: 'selected',
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        i = idss[0]['id'];
                        window.location.href='{!! url("categoria")!!}/'+i+'/edit';
                    }
                },
                {
                    extend: 'selected',
                    ...
                    action: function ( e, dt, node, config ) {
                        ...
                        if (confirm('¿Desea eliminar la fila seleccionada?')){
                            $('#form_delete').attr("action", '{!! url("categoria")!!}/' + i);
                            $('#form_delete').submit();
                        }
                    }
                },
